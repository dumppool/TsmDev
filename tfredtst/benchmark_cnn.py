...
#proparams._DEFAULT_PARAMS.update(platforms_util.get_platform_params())
...
# to value, with one field per key in proparams._DEFAULT_PARAMS.
#
...
# Params directly.
Params = namedtuple('Params', proparams._DEFAULT_PARAMS.keys())  # pylint: disable=invalid-name
